...
export default function AdditionalInfoSection() {
  return (
    <section id="additional-information" className="py-12 scroll-mt-24 lg:scroll-mt-0">
          ...
          >
            ...
            <div className="space-y-6">
              {volunteerExperiencesData.map((experience) => (
                <div key={`${experience.organization}-${experience.role}`} className="bg-surface/80 backdrop-blur-sm border border-white/10 p-6 rounded-lg shadow-lg">
