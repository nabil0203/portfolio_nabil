...
const HeroButton: React.FC<HeroButtonProps> = ({ href, children, Icon, ariaLabel }) => (
  <motion.a
    ...
    className="relative group inline-flex items-center justify-center gap-2 sm:gap-3 px-3 sm:px-8 py-2 sm:py-3.5 w-[calc(50%-0.375rem)] sm:w-auto rounded-2xl bg-white/5 backdrop-blur-lg overflow-hidden border border-accent/25 group-hover:border-accent/50 transition-all duration-100"
  >
